    ...
    <section className="container px-4 py-24">
      ...
      <div className="max-w-2xl mb-20">
        <h2 className="text-5xl md:text-6xl font-normal mb-6 tracking-tight text-left">
          Everything You Need
          <br />
          <span className="text-gradient font-medium">In One Platform</span>
        </h2>
        <p className="text-lg md:text-xl text-gray-400 text-left">
          Powerful marketing tools that integrate seamlessly with your favorite platforms. From CRM to social media planning.
        </p>
      </div>
